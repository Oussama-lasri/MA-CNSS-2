...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            UI.MAIN_MENU();
            choice = PmScanner.takeUserChoice(0, 5);
            switch (choice) {
//              ADMIN
                case 1:
                    // => LOGIN
...
//              Agent CNSS
                        ...
                        switch (choice) {
                            case 1:
                                ...
                                if (agentCNSS != null) {
                                    ...
                                    System.err.println("Le dossier pas ajouter");
                                }
                                break;
                        }
                    } while (choice != 0);
                ...
                case 4 :
                    ...
                    //if (agentCNSS == null) {
                      //  break;
                    //}
                    System.out.println("Welcome Societe 💪🏼");
                    ...
                    do {
                        ...
                        switch (choice) {
                            case 1:
                                //if(SocieteServices.login() != null){

                                    Societe societe = SocieteServices.login();
                                    do {
                                        UI.SOCIETE_MENU_AFTER_LOGIN();
                                        choice = PmScanner.takeUserChoice(0,5);
                                        switch (choice){
                                            case 1 :
                                                EmployeeServices.addEmplyeeInSociete(societe);
                                                break;
                                            case 2 :
                                                EmployeeServices.createEmployee(societe.getId());
                                                break;
                                            case 3:
                                                EmployeeServices.canRetire();
                                        }
                                    }while(choice != 0);
